...
<body class="align">
    ...
    <div class="login">
        ...
        <form action="#" class="login__form" id="form" method="POST">
            <div class="form-floating">
                <input autocomplete="off" required type="password" class="form-control" name="password" id="password" placeholder="New Password" value="">
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            axios.post(window.location.href, data)
                .then(function(response) {
                    ...
                    msgError.style.display = 'none';
                    msgSuccess.innerHTML = `Password successfully reset`;
        ...
        password.addEventListener('input', checkFieldOk);


        function checkFieldOk(e) {
            if (password.value.length == 0) return btnSubmit.setAttribute('disabled', 'disabled');
